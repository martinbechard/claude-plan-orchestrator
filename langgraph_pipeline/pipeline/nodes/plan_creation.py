...
PLAN_CREATION_PROMPT = (
    ...
    "- **design-judge**: Phase 0 judge for design competitions. Reads competing designs,\n"
    "  scores each on 5 criteria, declares the winner with written rationale, and writes\n"
    "  the judgment to tmp/worker-output/. Always completes autonomously — never suspends.\n"
    "  Use agent: design-judge for the judge task (0.6 pattern) in Phase 0 competitions.\n\n"
    "## Validation\n\n"
